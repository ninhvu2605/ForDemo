...
if(isset($_POST['check-out'])){
	...
	$time = time();
        ...
        $sql = 'INSERT INTO order(customer_name, customer_address, total_price, date_modified, customer_phone, pay) VALUES("$name", "$address", "$total_amount", "$time", "$phone", "$pay") RETURNING id'; 
