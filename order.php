...
if(isset($_POST['check-out'])){
	...
	$time = time();
        ...
        $sql = 'INSERT INTO "order"(orderid ,customer_name, customer_address, total_price, date_modified, customer_phone, pay) VALUES(DEFAULT,"$name", "$address", "$total_amount", "$time", "$phone", "$pay") RETURNING orderid'; 
